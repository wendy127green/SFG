...
class PipelineFlownet:
	...
	def train_batch(self, raw_weight, dist_weight, img1, img2, lmk1s, lmk2s, sift1, sift2, color_aug, aug):
		losses = []
		reg_losses = []
		raw_losses = []
		dist_losses = []
		...
		with autograd.record():
			for img1s, img2s, lmk1, lmk2, sift1s, sift2s in zip(img1, img2, lmk1s, lmk2s, sift1, sift2):
				...
				loss = raw_loss * raw_weight + reg_loss * self.reg_weight + dist_loss*dist_weight
				losses.append(loss)
