...
while True:
	...
	img1, img2, lmk1, lmk2 = [batch[i] for i in range(4)]
	dist_weight = args.weight
	train_log = pipe.train_batch(dist_weight, img1, img2, lmk1, lmk2, color_aug, aug)

	# if args.weakly_supervised:
	# 	img1, img2, lmk1, lmk2 = [batch[i] for i in range(4)]
	# 	train_log = pipe.train_batch_weakly_supervised(img1, img2, lmk1, lmk2, aug)
	# else:
	# 	img1, img2 = [batch[i] for i in range(2)]
	# 	train_log = pipe.train_batch_unsupervised(img1, img2, aug)
