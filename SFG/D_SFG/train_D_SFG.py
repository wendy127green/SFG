...
prep_name = args.prep
data_path = r"/home/gelin/SFG/D_SFG/datasets/"
siftdir = "/home/gelin/SFG/D_SFG/datasets/multi_siftflowmap_"+prep_name
...
def iterate_data(iq, gen):
	...
	while True:
		...
		if dataset_cfg.dataset.value == "ANHIR":
			...
			fsift2 = train_pairs[i][2]
			fsift1 = train_pairs[i][3]
...
while True:
	...
	img1, img2, sift1, sift2 = [batch[i] for i in range(4)]
	...
	train_log = pipe.train_batch(raw_weight, img1, img2, sift1, sift2, color_aug, aug)
	# update log
