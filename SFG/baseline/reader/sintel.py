...
# ======== PLEASE MODIFY ========
sintel_root = r'F:\linge\data2\Sintel'
split_file = r'F:\linge\data2\Sintel\Sintel_train_val_maskflownet.txt' # r'path\to\your\Sintel\Sintel_train_val_maskflownet.txt'
