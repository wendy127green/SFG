...
def LoadANHIR(prep_name, subsets = [""], data_path = r"/home/gelin/SFG/D_SFG/datasets/"):

    siftdir = "/home/gelin/SFG/D_SFG/datasets/multi_siftflowmap_"+prep_name###########multi D-SFG
    # siftdir = "/home/gelin/SFG/D_SFG/datasets/siftflowmap_"+prep_name###########single D-SFG
        ...
        for row in reader:
            ...
            if row[5] == 'training':
                ...
                if fimg not in dataset:
                    ...
                    groups[group].append((fimg, fsift1))
                    train_groups[group].append((fimg, fsift1))
                ...
                if fimg not in dataset:
                    ...
                    # # dataset[fimg] = np.expand_dims(io.imread(os.path.join(prep_path, fimg), as_gray=True), axis=0)
                    # dataset[fimg] = im_temp2
                    groups[group].append((fimg, fsift2))
                    train_groups[group].append((fimg, fsift2))
            ...
            if row[5] == 'training':
                ...
                if fimg not in dataset:
                    ...
                    try:
                        ...
                        # dataset[flmk] = lmk
                        #print('lmk original length: 0')
                        groups[group].append((fimg, flmk, fsift1))
                        train_groups[group].append((fimg, flmk, fsift1))
                    else:
                        # dataset[flmk] = lmk
                        groups[group].append((fimg, flmk, fsift1))
                        train_groups[group].append((fimg, flmk, fsift1))
